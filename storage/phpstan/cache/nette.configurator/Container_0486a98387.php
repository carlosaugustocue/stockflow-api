...
class Container_0486a98387 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_0486a98387 $container)
			{
	...
	public function createServiceContainer(): Container_0486a98387
	{
		return $this;
	}
