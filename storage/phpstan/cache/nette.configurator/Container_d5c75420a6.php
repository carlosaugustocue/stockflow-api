...
class Container_d5c75420a6 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_d5c75420a6 $container)
			{
	...
	public function createServiceContainer(): Container_d5c75420a6
	{
		return $this;
	}
