...
class Container_43cb7a1ee3 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_43cb7a1ee3 $container)
			{
	...
	public function createServiceContainer(): Container_43cb7a1ee3
	{
		return $this;
	}
