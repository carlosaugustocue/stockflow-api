...
class Container_3f14cbc5f5 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_3f14cbc5f5 $container)
			{
	...
	public function createServiceContainer(): Container_3f14cbc5f5
	{
		return $this;
	}
