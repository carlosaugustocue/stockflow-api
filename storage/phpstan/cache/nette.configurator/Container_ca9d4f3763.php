...
class Container_ca9d4f3763 extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_ca9d4f3763 $container)
			{
	...
	public function createServiceContainer(): Container_ca9d4f3763
	{
		return $this;
	}
