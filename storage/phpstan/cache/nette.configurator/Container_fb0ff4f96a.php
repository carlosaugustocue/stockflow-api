...
class Container_fb0ff4f96a extends _PHPStan_37ef388af\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0445(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_fb0ff4f96a $container)
			{
	...
	public function createServiceContainer(): Container_fb0ff4f96a
	{
		return $this;
	}
